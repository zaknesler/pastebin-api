...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ExampleComponent_vue__ = __webpack_require__(34);
...
Vue.component('example-component', __WEBPACK_IMPORTED_MODULE_1__components_ExampleComponent_vue___default.a);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65163a6b", Component.options)
  } else {
    hotAPI.reload("data-v-65163a6b", Component.options)
  }
  ...
  return _c("div", { staticClass: "w-full" }, [
    _c("div", { staticClass: "border rounded" }, [
      _c(
        ...
        {
          staticClass:
            "border-b bg-grey-lightest rounded-t text-grey-darker font-semibold px-4 py-3"
        },
        [_vm._v(_vm._s(_vm.title || "Example Component"))]
      ),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "bg-white rounded-b p-4" },
        [_vm._t("default", [_vm._v("I'm an example component!")])],
        2
      )
    ])
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-65163a6b", module.exports)
  }
}
